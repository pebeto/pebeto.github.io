...
export default async function Tools() {
    const devTools = [
        ...
        { title: "Code assistant", value: "OpenCode", desc: 'Running unsloth/GLM-4.7-Flash-GGUF. I prefer to "operate" it and understand the solution before using it.', href: "https://opencode.ai/" },
