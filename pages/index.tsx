...
import { Image, Grid, Page, Spacer, Text, Link } from '@geist-ui/core';
        ...
        <Grid.Container justify="center">
          ...
          <Grid lg direction="column">
            <Text p>
              ...
              Learning, Data Science and Developing. My experience in both
              academics and industry makes me aware of novelty and fast driving,
              as well as good analytical skills. I worked with multi-national
              teams, mostly speaking the English language, giving me an integral
              communication fluency. Some of my work are related with complex
              systems using large data pipelines, as well as performing analysis
            ...
            <Text>
              ...
              fifth wave of emo, so I'm proud of it. I also like to play Magic
              The Gathering and I have two cats.
            </Text>
            <Spacer />
            <Grid>
              ...
              <Spacer inline={true} />
              <Link
                href="https://www.linkedin.com/in/josesparza/"
                target="_blank"
              >
