    ...
    <Wrapper>
      <Grid.Container>
        <Grid>
          ...
          <Text p>
            Also I'm using MacOS Ventura on my laptop for daily and common
            usage. I'm not a big fan of Apple, but the entire OS nice
            integration is something admirable.
          </Text>
        </Grid>
        <Grid.Container gap={2}>
          <Grid xs={25} md={25} lg={15} direction="column">
          ...
          <Grid xs={25} md={25} lg={9} direction="column">
            <Display
              caption={
                <Text p>
                  <Link
